...
**Azione necessaria**
- introdurre una tabella dedicata:
...
**Azione necessaria**
- valutare una tabella concettuale:
  - `tables/natural_events.md`
...
**Azione necessaria**
- chiarire se formalizzare:
  - soglie
  - criteri qualitativi
- possibile estensione del framework:
  - M_SUPERSITE
