...
### v2.1 (amendments to v2.0)

- `action.verb`: added `assist` and `propose` to the closed list
- `qualifiers`: added `where_applicable` to the closed list
- `normative_role`: added disambiguation note for `assist`-type obligations
